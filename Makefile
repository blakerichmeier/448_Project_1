battleship: main.o Executive.o gameBoard.o test_input.o user_input.o ship.o
	g++ -g -std=c++11 -Wall main.o Executive.o gameBoard.o test_input.o user_input.o ship.o -o battleship
